...
- [x] **Шаг 4:** Дашборд модератора: список отчётов, бейджи просрочки, интерфейс изменения баллов с обязательным комментарием.
- [x] **Шаг 5:** Публичная страница рейтинга (`/rating`) с фильтрацией по семестрам и категориям.
- [x] **Шаг 6:** Админ-панель: просмотр аудита, кнопка принудительной синхронизации с Яндексом, управление правилами (JSONB формы).
